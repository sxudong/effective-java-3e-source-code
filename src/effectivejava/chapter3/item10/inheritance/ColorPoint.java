...
// Attempting to add a value component to Point 尝试向Point添加值组件 (Page 33)
...
//            return false;
//
//        // If o is a normal Point, do a color-blind comparison. 如果o是正常点，则进行色盲比较
//        if (!(o instanceof ColorPoint))
...
//    }
    ...
    public static void main(String[] args) {
        // First equals function violates symmetry 违反对称性(Page 34)
        Point p = new Point(1, 2);
        ColorPoint cp = new ColorPoint(1, 2, Color.RED);
        System.out.println(p.equals(cp) + " " + cp.equals(p)); // true  false

        // Second equals function violates transitivity 违反传递性 (Page 34)
        ColorPoint p1 = new ColorPoint(1, 2, Color.RED);
        Point p2 = new Point(1, 2);
        ColorPoint p3 = new ColorPoint(1, 2, Color.BLUE);
        System.out.printf("%s %s %s%n",
                          p1.equals(p2), p2.equals(p3), p1.equals(p3)); // false true false
    }
}
